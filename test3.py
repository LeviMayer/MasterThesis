...
MODEL_WEIGHTS_PATH = "C/home/levi/ros2-turtlebot4-devcontainer/visualnav-transformer-main/deployment/model_weights"
MODEL_CONFIG_PATH = "/home/levi/ros2-turtlebot4-devcontainer/visualnav-transformer-main/deployment/config/models.yaml"
...
model_name = "nomad"
model_config_path = "/home/levi/ros2-turtlebot4-devcontainer/visualnav-transformer-main/train/config/nomad.yaml"
...
context_queue = []
context_queue.append(image1).append(image2).append(image3).append(image4)
